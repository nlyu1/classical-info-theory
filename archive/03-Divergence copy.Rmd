...
1. Differential entropy? Don't understand the part in the book. 
2. Entropy-divergence relation for continuous variables? (Gaussian divergence?)
</div>
...
## Conditional divergence, Chain Rule, DPI {-}

The joint divergence can be written as the sum of marginal 
and conditional divergences, where the latter is defined below: 
