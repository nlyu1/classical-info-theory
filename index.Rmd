...
5. <u>Harremoës-Vadja</u> (theorem \@ref(thm:harremoesVajda)): 
    one theorem to rule them all for $f$-divergence joint range. 
6. Most $f$-divergences are locally $\chi^2$-like about 
...
8. Break a single $\sup$ into nested ones. 
    - Solve the inner $\sup$ analytically: 
    useful characterization of $\chi^2$ \@ref(eq:chiStatVar). 
